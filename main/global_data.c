...
T_HTTP_PROCCESSING_TYPE http_processing[] = {
		...
		{"/cfg/ota/status",  0,                    HP_CFG_OTA_STATUS, "ota status" },
...
T_EVENT_CONFIG event_config_tab[] = {
		...
		{ET_BMP_READ, EVT_PARA_NUMERIC | EVT_PARA_OPTIONAL, "bmp_read",         "read BMP data line by line and display it",      "execution time in ms, -1 until end (default)"},
